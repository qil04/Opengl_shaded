...
void CChildView::InitGL()
{
	...
	m_fish.m_program = LoadShaders("ShaderWnd/vertexSphere2.glsl", "ShaderWnd/fragmentSphere2.glsl");
	m_fish.InitGL();
	...
	//m_metallicSphere.m_program = LoadShaders("ShaderWnd/vertexSphere2.glsl", "ShaderWnd/fragmentSphere2.glsl");
	//m_metallicSphere.InitGL();
	m_cylinder.m_program = LoadShaders("ShaderWnd/vertexSphere2.glsl", "ShaderWnd/fragmentSphere2.glsl");
	m_cylinder.InitGL();
...
void CChildView::RenderGL()
{
	...
	M = translate(mat4(1.f), vec3(10., 0., 10.)) * rotate(mat4(1.f), 270.f, vec3(1., 0., 0.));
	VM = m_mVM * M;
	PVM = m_mPVM * M;
	...
	M = translate(mat4(1.f), vec3(0., 8.f, 0.));
	VM = m_mVM * M;
	PVM = m_mPVM * M;
